        ...
        <div class="col-md-12 content-item">
            ...
            <div class="col-md-9">
                <ul class="nav nav-tabs" role="tablist">
                    <li class="active">
                        <a class="nav-link active" data-toggle="tab" href="#records" role="tab">Records</a>
                    </li>
                    <li class="nav-item">
                        <a data-toggle="tab" href="#information" role="tab">More Information</a>
                    </li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane active" id="records" role="tabpanel">
