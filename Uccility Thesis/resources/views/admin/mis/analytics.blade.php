...
<div class="col-md-12 contents">
    <div class="col-md-12 content-tiles">
        <div class="col-md-3 content-row">
            <div class="col-md-12 content-item">
                <h3>Users</h3><hr>
                <h1><i class="icon-uccility-id" style="font-size: 42px;"></i> 3476</h1><hr>
                <p>Current Overall Total of Users...</p>
                <h3>New Users</h3><hr>
                <h1><i class="icon-uccility-id" style="font-size: 42px;"></i> 271</h1><hr>
    ...
    <div class="col-md-9 content-row">
        <div class="col-md-12 content-item">
            <h3>User Entry to the System</h3><hr />
